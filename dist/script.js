...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      ...
      /* window.pageYOffset - выслта то что пролестали от начало экрана до скрола,
      document.documentElement.clientHeight - выслта то что показываеться на экране  */
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])('http://localhost:3000/styles')
    /* или assets/db.json */
    .then(function (res) {
